...
class ArticleEdit extends Component {
    ...
    handleSubmit = (event) => {
        ...
        const body = this.state.body ? this.state.body : this.props.article.body;
        const article = { id: id, title: title, body: body }
        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        <label>Content</label>
                        <textarea name="body" rows="5" defaultValue={this.props.article.body} onChange={this.handleChange} className="form-control" />
                    </div>
